...
book1 = Book(user_id=1, title="Everything I Never Told You", author="Celeste Ng", description="Thats going to be a really sad story about someone dying",  genre=genre6 ,library=library1)

session.add(book1)
session.commit()

book2 = Book(user_id=1, title="Is Everyone Hanging Out Without Me?", author="Mindy Kaling",description="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua", genre=genre1, library=library1)
